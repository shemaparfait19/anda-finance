...
export default function CashbookTable({ data, type }: { data: CashbookEntry[], type: 'Income' | 'Expenses' }) {
            ...
            {data.map((entry) => (
              <TableRow key={entry.id}>
                ...
                <TableCell className="text-right">
                  <CashbookRowActions entry={entry} type={type.toLowerCase() as 'income' | 'expenses'} />
                </TableCell>
              </TableRow>
            ))}
